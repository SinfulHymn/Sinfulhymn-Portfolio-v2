...
![tailwind-nextjs-banner](/static/images/X-card.png)
...
Using the template? Support this effort by giving a star on GitHub, sharing your own blog and giving a shoutout on X or be a project [sponsor](https://github.com/sponsors/timlrx).
