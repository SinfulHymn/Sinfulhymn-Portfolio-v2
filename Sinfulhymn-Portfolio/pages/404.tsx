  ...
  return (
    <>
      ...
      <div className="flex flex-col items-start gap-6 pt-10 md:flex-row md:items-center">
        <h1 className="hairline border-r-0 pr-0 font-display text-6xl leading-none text-primaryText dark:text-fgTextDark md:border-r md:pr-6 md:text-8xl">
          404
        </h1>
        <div className="max-w-md space-y-4">
          <p className="font-mono text-xl leading-normal text-primaryText dark:text-fgTextDark md:text-2xl">
